...
export default function LeadMagnetForm() {
  ...
  if (leadFormSubmitted) {
    return (
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-laranja-400">
          ...
          <form onSubmit={handleLeadFormSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-laranja-400 focus:border-transparent"
            ...
            <div className="flex items-start">
              ...
              <label htmlFor="lead-lgpd" className="ml-3 text-sm text-gray-600">
                Aceito receber comunicações da Desbrave e concordo com a <a href="#privacidade" className="text-laranja-400 underline">Política de Privacidade</a>. *
              </label>
            </div>
            {leadFormError && (
            ...
            <button
              ...
              className={`w-full bg-laranja-400 text-white px-8 py-4 rounded-full transition-all transform shadow-lg font-semibold text-lg ${leadFormLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-laranja-500 hover:scale-105'}`}
            >
