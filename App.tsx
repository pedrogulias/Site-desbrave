        ...
        "@graph": [
          {
            ...
            "description": "Roteiros guiados de cicloturismo na Serra Gaúcha e litoral do RS. Pedalares inesquecíveis com segurança e leveza.",
            "address": {
              "@type": "PostalAddress",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                Pedalares inesquecíveis na Serra Gaúcha — com leveza, segurança e boas companhias
              </h1>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Pedalares inesquecíveis na Serra Gaúcha, litoral e Porto Alegre.
              </p>
            </div>
